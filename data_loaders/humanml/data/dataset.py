...
class StyleDataset(data.Dataset):
    def __init__(self, mode, datapath='./dataset/stylexia_posrot_opt.txt', split="train", dataset_name='stylexia_posrot', **kwargs):
        self.mode = mode
        
        self.dataset_name = dataset_name
        self.dataname = dataset_name
       
        if dataset_name == 'bandai-1_posrot':
        ...
        self.split = split
        if mode in ['train', 'eval', 'text_only']:
            if self.dataset_name in ["bandai-1_posrot", "bandai-2_posrot"]:
