...
class GaussianDiffusion:
    ...
    def few_shot_style_finetune_losses(self, model, x_start, t, x_content_start, x_style_start, skip_steps=700, model_kwargs=None, noise=None, model_t2m_kwargs=None, semantic_guidance=0, use_ddim=0, Ls=10):
        # x_content_start is for learning the translation between content_motion and style motion
        # x_style_start is the input style example motion 
        try:
        ...
        if self.loss_type == LossType.MSE or self.loss_type == LossType.RESCALED_MSE:
            ...
            if semantic_guidance:     
                terms["loss"] = terms["rot_mse"].mean()  + terms["text_cosine"] * Ls
            else:
