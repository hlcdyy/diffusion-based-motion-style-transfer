...
class StyleDiffusion(nn.Module):
    ...
    def load_motion_enc(self):
        print("load motion_enc from checkpoint {}".format(self.kargs["semantic_discriminator_path"]))
        self.load_model(self.motion_enc, torch.load(self.kargs["semantic_discriminator_path"]))
